...
conda install -y libboost_python --file=linux-64/libboost_python-1.70.0-py36h39e3cac_0.tar.bz2 ## it should pick from statiskit
...
conda install -y boost-cpp rospkg catkin_pkg opencv ros-rosbag ros-sensor-msgs ros-rosconsole ros-roslib catkin_tools 
